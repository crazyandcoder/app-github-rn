...
import * as Config from '../../config/ignoreConfig'
...
function PullLoadMoreListView(props, ref) {
        ...
        let footer = (showLoadMore) ?
            <View style={{
                ...
                <Text style={{fontSize: 15, color: 'black'}}>
                    {Translate.translate.en.loadMoreing}
                </Text>
            </View> : <View style={{
                flexDirection: 'row',
                justifyContent: 'center',
                ...
                <Text style={{fontSize: 15, color: 'black', margin: Constant.normalMarginEdge}}>
                    {props.dataSource != null && props.dataSource.length > 0 ? Translate.translate.en.loadMoreEnd : " "}
                </Text>
            </View>;
            ...
            <View style={[styles.centered, {
                ...
                <TouchableOpacity style={[styles.centered, {flex: 1}]}
                    ...
                    <Text style={[styles.normalText]}>
                        {Translate.translate.en.listEmpty}
                    </Text>
                </TouchableOpacity>
            </View> : <View/>;
    }
    ...
    let refreshProps = {
        ...
        title: Translate.translate.en.refreshing,
